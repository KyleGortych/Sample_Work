...
def main():
    print('''Blackjack, by Kyle Gortych from Al Sweigart
...
def getBet(maxBet):
    """Ask the player how much to bet for this round."""
    while True:
...
def getMove(playerHand, money):
    """Asks player for their move, and returns 'H' for hit, 'S' for stand, and 'D' for double down."""
    while True:
        moves = ['(H)it', '(S)tand']
